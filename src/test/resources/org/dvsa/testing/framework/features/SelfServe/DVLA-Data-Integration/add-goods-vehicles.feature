...
Feature: Search and add a vehicle
  ...
  @smoketest @dvla-add-vehicle @localsmoke @reads-system-properties
  ...
  @dvla-add-vehicle-another-licence @reads-system-properties
  ...
  @dvla-remove-vehicle @localsmoke @reads-system-properties
  ...
  @dvla-reprint @localsmoke @reads-system-properties
