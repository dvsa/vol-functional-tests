...
Feature: Goods Variation increase vehicle count for an OC
  ...
  Scenario: Create a variation and increase vehicle count for standard national licence
    Given i have a valid "goods" "standard_national" licence
    When i increase my vehicle authority count
    Then a status of update required should be shown next to financial evidence

  Scenario: Create a variation and increase vehicle count for restricted licence
  ...
  @CPMS_tests
  Scenario: Create a variation and add operating centre for standard national licence
    Given i have a valid "goods" "standard_national" licence
  ...
  Scenario: Create a variation and add operating centre for restricted licence
    Given i have a valid "goods" "restricted" licence
    And a selfserve user creates a variation and adds an operating centre
    And i pay for my application
    And i create an admin and url search for my variation
