...
public class PaymentProcessing extends BasePage {
    ...
    public void whenIPayForTheFeeBy(String arg0) {
        ...
        refreshPage();
        String feeAmount = findElement("//*/tbody/tr[1]/td[5]", SelectorType.XPATH, 10).getText().substring(1);
    ...
    public void iAddANewFee(String arg0) {
        ...
        String feeCountBeforeAddingNewFee = waitAndGetElementValueByText("//*[@class='govuk-table__caption govuk-table__caption--m']", SelectorType.XPATH);
