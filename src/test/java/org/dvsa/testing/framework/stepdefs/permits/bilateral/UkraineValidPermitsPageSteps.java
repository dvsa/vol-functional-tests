...
public class UkraineValidPermitsPageSteps implements En {

    public UkraineValidPermitsPageSteps(OperatorStore operatorStore, World world) {
        And("^The content and information on Ukraine valid permits is correct$", () -> {
