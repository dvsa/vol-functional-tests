...
public class InternalSearch extends BasePage {
    ...
    public void iSelectAndSearchForAVehicleByRegistration() {
        world.internalSearchJourney.searchAndViewVehicleRegistration();
    }

    @Then("the registered VRM should display")
    public void theRegisteredVRMShouldDisplay() {
        world.internalSearchJourney.registeredVRMDisplay();
    }
