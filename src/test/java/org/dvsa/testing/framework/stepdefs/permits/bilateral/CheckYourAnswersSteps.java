...
public class CheckYourAnswersSteps extends BasePage {
    World world;
    ...
    @And("I am on the Annual Bilateral {string} check your answers page with correct information and content")
    public void iAmOnTheAnnualBilateralCheckYourAnswersPage(String country) {
