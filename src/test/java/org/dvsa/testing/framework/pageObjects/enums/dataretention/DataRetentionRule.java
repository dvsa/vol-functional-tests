    ...
    public static org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule getEnum(String value) {
        ...
        switch (value.toLowerCase()) {
            case "irfo operator expired":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.IRFO_OPERATOR_EXPIRED;
                break;
            case "irfo gv permit expired":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.IRFO_GV_PERMIT_EXPIRED;
                break;
            case "irfo psv authorisation expired":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.IRFO_PSV_AUTHORISATION_EXPIRED;
                break;
            case "irfo psv auth withdrawn,pending,refused etc expired":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.IRFO_PSV_AUTH_WITHDRAWN_PENDING_REFUSED_ETC_EXPIRED;
                break;
            case "irfo gv permit withdrawn pending or refused expired":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.IRFO_GV_PERMIT_WITHDRAWN_PENDING_OR_REFUSED_EXPIRED;
                break;
            case "licence not yet submitted":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.LICENCE_NOT_YET_SUBMITTED;
                break;
            case "applications refused":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.APPLICATIONS_REFUSED;
                break;
            case "transport Managers with Public inquirys":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.TRANSPORT_MANAGERS_WITH_PUBLIC_INQUIRYS;
                break;
            case "licence with pi, no impounding and not unlicenced":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.LICENCE_WITH_PI_NO_IMPOUNDING_AND_NOT_UNLICENCED;
                break;
            case "licence with impounding and not unlicenced":
                dataRetentionRule = org.dvsa.testing.framework.pageObjects.enums.dataretention.DataRetentionRule.LICENCE_WITH_IMPOUNDING_AND_NOT_UNLICENCED;
                break;
            default:
