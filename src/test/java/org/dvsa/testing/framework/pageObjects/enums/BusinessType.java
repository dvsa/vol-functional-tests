...
public enum BusinessType {
    ...
    public static org.dvsa.testing.framework.pageObjects.enums.BusinessType getEnum(@NotNull String businessType) {
        org.dvsa.testing.framework.pageObjects.enums.BusinessType businessTypeEnum;
